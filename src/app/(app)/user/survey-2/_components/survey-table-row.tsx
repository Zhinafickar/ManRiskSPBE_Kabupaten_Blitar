...
import { FREQUENCY_LEVELS, IMPACT_MAGNITUDES, AREA_DAMPAK_OPTIONS } from '@/constants/analysis';
import { ORGANIZATIONAL_CONTROLS, PEOPLE_CONTROLS, PHYSICAL_CONTROLS, TECHNOLOGICAL_CONTROLS } from '@/constants/controls';
